...
namespace FavMovies.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, FavMovies.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((FavMovies.EntityType)entityTypeValue); }
	...
	/// <summary>Factory to create new, empty MovieEntity objects.</summary>
	[Serializable]
	public partial class MovieEntityFactory : EntityFactoryBase2<MovieEntity> 
	{
		/// <summary>CTor</summary>
		public MovieEntityFactory() : base("MovieEntity", FavMovies.EntityType.MovieEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new MovieEntity(fields); }
	}

	/// <summary>Factory to create new, empty MovieinfoEntity objects.</summary>
	[Serializable]
	public partial class MovieinfoEntityFactory : EntityFactoryBase2<MovieinfoEntity> 
	{
		/// <summary>CTor</summary>
		public MovieinfoEntityFactory() : base("MovieinfoEntity", FavMovies.EntityType.MovieinfoEntity, false) { }
		/// <inheritdoc/>
		protected override IEntity2 CreateImpl(IEntityFields2 fields) { return new MovieinfoEntity(fields); }
	}
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(FavMovies.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(FavMovies.EntityType)))
			{
				var factory = GetFactory((FavMovies.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the FavMovies.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(FavMovies.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case FavMovies.EntityType.MovieEntity:
					return new MovieEntityFactory();
				case FavMovies.EntityType.MovieinfoEntity:
					return new MovieinfoEntityFactory();
				default:
					return null;
			}
		}
	...
	{
		/// <summary>Gets the factory of the Entity type with the FavMovies.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (FavMovies.EntityType)Enum.Parse(typeof(FavMovies.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((FavMovies.EntityType)Enum.Parse(typeof(FavMovies.EntityType), leftOperandEntityName, false), joinType, (FavMovies.EntityType)Enum.Parse(typeof(FavMovies.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (FavMovies.EntityType)Enum.Parse(typeof(FavMovies.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((FavMovies.EntityType)entityTypeValue); }

...
namespace FavMovies.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((FavMovies.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting MovieEntity instances in the database.</summary>
		public DataSource2<MovieEntity> Movie {	get { return new DataSource2<MovieEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
		
		/// <summary>returns the datasource to use in a Linq query when targeting MovieinfoEntity instances in the database.</summary>
		public DataSource2<MovieinfoEntity> Movieinfo {	get { return new DataSource2<MovieinfoEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
